...
class AuthController extends Controller
{
  ...
  *              example={"name": "jono", "email": "jonolim@gmail.com", 
  *"password": "678090vk", "password_confirmation": "678090vk"}
  *          ),
  *      )
  * )
  */   
  public function register(Request $request){
    try {
        ...
        return response()->json(
            array('name' => $request->name, 'email' => $request->get('email'), 'token'
            => $token),
            200
        );
  ...
  *          @OA\JsonContent(
  *              ref="#/components/schemas/User",
  *              example={"email": "jonolim@gmail.com", "password": "678090vk"}
  *          ),
  *      )
  * )
  */   
