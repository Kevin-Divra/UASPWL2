...
class Transaction extends Model
{
    ...
    public function get_transaction()
    {
        $sql = $this->select(
            ...
            ->groupBy('transaksi_penjualan.id', 'transaksi_penjualan.id_kasir', 'transaksi_penjualan.created_at', 'transaksi_penjualan.updated_at', 'kasir.nama_kasir');
