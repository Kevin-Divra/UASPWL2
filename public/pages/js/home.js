...
function getData(){
    ...
    .then(function (response) {
        ...
        (response.data.products).forEach((item) => {
            template += `
            <div class="single-hero-slider-7" onclick="location.href='`+baseUrl+`/babyneed/`+item.id+`'">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-content-wrap">
                                <div class="hero-text-7 mt-lg-5">
                                    <h6 class="mb-20">
                                        Latest from Baby's Best
                                    </h6>
                                    <h1>`+breakWord(item.Nama)+`</h1>
