function getDataByWindowUrlKey(){
    ...
    let url = baseUrl+'/api/babyneed/'+windowUrlKey;
    ...
    .then(function (response) {
      ...
      $('#product-Nama').html(response.data.Nama);
      ...
      // START -- note, unless you have these data in a database structure, here we are hardcoding them for display purposes
        ...
        // tag
        let collectionOfTag = ['pakaian','mainan','peralatan mandi','popok','Perlengkapan Berpergian','Perlengkapan tidur','Peralatan menyusui','Perlengkapan Ganti Popok'];
