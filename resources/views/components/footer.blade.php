    ...
    <div class="footer-area section-space--pb_90">
        <div class="container-fluid container-fluid--cp-100">
            <div class="row footer-widget-wrapper">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 footer-widget">
                    <h6 class="footer-widget_title mb-20">Company</h6>
                    <ul class="footer-widget_list">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 footer-widget">
                    <h6 class="footer-widget_title mb-20">Social Media</h6>
                    <ul class="footer-widget_list">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 footer-widget">
                    <h6 class="footer-widget_title mb-20">Newsletter</h6>
                    <div class="footer-widget_newsletter mt-30">
        ...
        <div class="container-fluid container-fluid--cp-100">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 order-md-1 order-2">
                    <span class="copyright-text text-center text-md-start">&copy; 2024
                    BABYSHOP. <a href="https://hasthemes.com/" target="_blank">All Rights
                    Reserved.</a>    
                    </span>
                </div>
