            ...
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <h5><strong>Total Amount:</strong> Rp {{ number_format($data->total_price, 0, ',', '.') }}</h5>
                            <h5><strong>Status:</strong> {{ ucwords($data->status) }}</h5>
                        </div>

                        <a href="{{ route('payment.index') }}" class="btn btn-primary mt-4">Back to Payments</a>
                    </div>
                </div>
            </div>
        </div>
